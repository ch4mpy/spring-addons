 ...
 *
 */
public class SpringIntrospectionClaimSet extends IntrospectionClaimSet {

	public SpringIntrospectionClaimSet(Map<String, Object> claims) {
		super(claims);
	}
	...
	public static class Builder<T extends Builder<T>> extends IntrospectionClaimSet.Builder<T> {
		...
		@Override
		public SpringIntrospectionClaimSet build() {
			return new SpringIntrospectionClaimSet(claimSet);
		}
	}
}
