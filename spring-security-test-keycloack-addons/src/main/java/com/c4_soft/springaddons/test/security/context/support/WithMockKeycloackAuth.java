...
import com.c4_soft.springaddons.test.security.context.support.WithMockKeycloackAuth.Factory;
...
public @interface WithMockKeycloackAuth {
	...
	public final class Factory implements WithSecurityContextFactory<WithMockKeycloackAuth> {
		...
		private static void feed(IDToken token, WithIDToken tokenAnnotation) {
