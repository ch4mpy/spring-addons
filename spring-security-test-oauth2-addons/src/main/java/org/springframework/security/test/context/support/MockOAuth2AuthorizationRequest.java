...
public @interface MockOAuth2AuthorizationRequest {
	...
	String authorizationGrantType() default OAuth2LoginAuthenticationTokenBuilder.DEFAULT_REQUEST_GRANT_TYPE;

	String authorizationUri() default OAuth2LoginAuthenticationTokenBuilder.DEFAULT_REQUEST_AUTHORIZATION_URI;

	String clientId() default OAuth2LoginAuthenticationTokenBuilder.DEFAULT_CLIENT_ID;

	String redirectUri() default OAuth2LoginAuthenticationTokenBuilder.DEFAULT_REQUEST_REDIRECT_URI;
