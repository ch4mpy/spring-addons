...
public @interface MockClientRegistration {
	...
	String authorizationGrantType() default OAuth2LoginAuthenticationTokenBuilder.DEFAULT_CLIENT_GRANT_TYPE;

	String clientId() default OAuth2LoginAuthenticationTokenBuilder.DEFAULT_CLIENT_ID;

	String registrationId() default OAuth2LoginAuthenticationTokenBuilder.DEFAULT_CLIENT_REGISTRATION_ID;

	String tokenUri() default OAuth2LoginAuthenticationTokenBuilder.DEFAULT_CLIENT_TOKEN_URI;
