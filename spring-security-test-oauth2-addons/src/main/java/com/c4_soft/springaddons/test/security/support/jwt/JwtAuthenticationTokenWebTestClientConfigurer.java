...
public class JwtAuthenticationTokenWebTestClientConfigurer
		extends
		JwtAuthenticationTokenTestingBuilder<JwtAuthenticationTokenWebTestClientConfigurer>
		implements
		AuthenticationConfigurer<JwtAuthenticationToken> {

	public JwtAuthenticationTokenWebTestClientConfigurer(
