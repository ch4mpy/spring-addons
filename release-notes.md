...
### `8.1.25`
- [gh-291](https://github.com/ch4mpy/spring-addons/issues/291) Ease the configuration of the `RestTemplate` instance used during OpenID configuration & JWK-set retrieval (see `9.1.1` above for a sample)
- [gh-290](https://github.com/ch4mpy/spring-addons/issues/290) Save `String`s instead of `URI`s in session
