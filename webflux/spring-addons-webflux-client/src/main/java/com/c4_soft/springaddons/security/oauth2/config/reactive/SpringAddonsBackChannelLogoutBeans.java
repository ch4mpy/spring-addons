 ...
 * Logout</a> specification. Keycloak conforms to this OP side of the spec.
 * <a href=
 * "https://community.auth0.com/t/openid-back-channel-logout-implementation/100112/8">Auth0</a>
 * could some day.
 * </p>
 * <p>
...
public class SpringAddonsBackChannelLogoutBeans {
    ...
    @Bean
    SecurityWebFilterChain springAddonsBackChannelLogoutClientFilterChain(
     ...
     * application/x-www-form-urlencoded as specified in <a href=
     * "https://openid.net/specs/openid-connect-backchannel-1_0.html">Back-Channel
     * Logout</a> specification.
     * </p>
     * <p>
     * This end-point will:
     * <ul>
     * <li>remove the relevant authorized client (based on issuer URI) for the
     * relevant user (based on the subject)</li>
     * <li>maybe invalidate user session: only if the removed authorized client was
     * the last one the user had</li>
     * </ul>
     *
     * @author Jerome Wacongne ch4mp&#64;c4-soft.com
     *
