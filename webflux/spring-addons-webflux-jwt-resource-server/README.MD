...
A thin wrapper around `spring-boot-starter-oauth2-client` which pushes auto-configuration one step further for reactive resource servers using JWT decoders.
