...
5.x branch requires **JDK 1.8** as minimum and spring boot up to 2.6.x

There is a 6.x branch for spring-boot 3 requiring JDK 17 as minimum.

Starters are designed for **spring-boot 2.6.x**  and before (boot auto-loading mechanisms have changed with 2.7).

You might explore [maven central](https://repo1.maven.org/maven2/com/c4-soft/springaddons/spring-addons/) to find which version are available.
...
```xml
    <properties>
        <springaddons.version>5.4.0</springaddons.version>
