...
`8.1.9` is :rocket:. It is designed to work with Spring Boot `3.4.4` (Security `6.4.4` and Cloud `2024.0.1`). See [the release notes](https://github.com/ch4mpy/spring-addons/blob/master/release-notes.md#800) for details.
