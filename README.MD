...
As I write this, latest `springaddons.version` is `3.1.4` but I could forget to update before releasing, so please refer to https://repo1.maven.org/maven2/com/c4-soft/springaddons/spring-addons/ to pick latest available release of one of the following:

```xml
	<properties>
		<!-- each release is made for JDKs 1.8, 11 and 17 -->
		<springaddons.version>3.1.4-jdk1.8</springaddons.version>
	</properties>
	<dependencies>
		<dependency>
