...
- one configuration class is loaded: `ServletSecurityBeans` for servlets and `ReactiveSecurityBeans` for reactive apps. It can not be overriden and your app shoudn't provide its own.
