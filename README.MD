...
- [How to configure an app with `JwtAuthenticationToken`](https://github.com/ch4mpy/spring-addons/blob/master/resource-server_with_jwtauthenticationtoken_how_to.md) (not so great because JwtAuthenticationToken has rather poor interface but it helps understand the security config this libs set-up)
