...
Please follow the [migration guide](https://github.com/ch4mpy/spring-addons/blob/master/7.0.0-migration-guide.md) to move from `6.x` to `7.1.7`. There is no urge to do so on existing projects as 6.2.x patches should be published untill the end of 2023.
...
```xml
    <properties>
        <springaddons.version>7.1.7</springaddons.version>
    </properties>
    <dependencies>
