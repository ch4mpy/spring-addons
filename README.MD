As of 6.0.0, transient dependencies are switched to spring-boot 3 (and spring-security 6): 6.0.4 is to be used with spring-boot 3.0.0-RC1.
...
```xml
    <properties>
        <springaddons.version>6.0.4</springaddons.version>
