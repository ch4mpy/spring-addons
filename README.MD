...
This provides with probably [better defaults than `spring-boot-starter-oauth2-resource-server`](https://github.com/spring-projects/spring-boot/issues/30108#issuecomment-1161475898) and none of Keycloaks libs limitations:
...
As I write this, latest version is `4.5.1-SNAPSHOT` but I could forget to update before releasing, so please refer to [maven central](https://repo1.maven.org/maven2/com/c4-soft/springaddons/spring-addons/) to pick latest available release of one of the following:

```xml
	<properties>
		<springaddons.version>4.5.1-SNAPSHOT</springaddons.version>
	</properties>
	<dependencies>
