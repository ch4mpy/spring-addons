As of 6.0.0, transient dependencies are switched to spring-boot 3 (and spring-security 6): 6.0.5 is to be used with spring-boot 3.0.0-RC2.
...
```xml
    <properties>
        <springaddons.version>6.0.5</springaddons.version>
