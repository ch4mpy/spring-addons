...
The complete list, with what each item is (a security flaw, a broken behaviour, or a test that lies) and the honest boundary of the claim, is on [what goes wrong without it](https://ch4mpy.github.io/spring-addons/what-goes-wrong/). The starter keeps Spring's defaults unless a property says otherwise, and the [`bff` sample](https://github.com/ch4mpy/spring-addons/tree/master/samples/bff) sets all of them.
...
The exact version of the current line is the one in the Maven Central badge above. Changes are documented per version in the [release notes](https://github.com/ch4mpy/spring-addons/blob/master/release-notes.md), and breaking changes in the migration guides ([7.0.0](https://github.com/ch4mpy/spring-addons/blob/master/7.0.0-migration-guide.md), [8.0.0](https://github.com/ch4mpy/spring-addons/blob/master/migrate-to-8.0.0.md), [8.4.0](https://github.com/ch4mpy/spring-addons/blob/8.4/migrate-to-8.4.0.md) / [8.5.0](https://github.com/ch4mpy/spring-addons/blob/8.5/migrate-to-8.5.0.md) when coming from `8.1.x`, [9.2.0](https://github.com/ch4mpy/spring-addons/blob/master/migrate-to-9.2.0.md)). The number of guides overstates the churn: `8.4.0`, `8.5.0` and `9.2.0` concern `spring-addons-starter-rest` only, and the last breaking change in `spring-addons-starter-oidc` is the `OAuthentication` class in `8.0.0`, which touched applications using that class and none of the properties.
