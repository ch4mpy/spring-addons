...
`8.1.9` is :rocket:. It is designed to work with Spring Boot `3.4.x` (Security `6.4.x` and Cloud `2024.0.x`). See [the release notes](https://github.com/ch4mpy/spring-addons/blob/master/release-notes.md#800) for details.
