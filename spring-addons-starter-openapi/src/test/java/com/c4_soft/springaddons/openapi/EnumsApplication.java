...
public class EnumsApplication {
  ...
  /**
   * A custom toString(), but no @JsonValue nor Converter&lt;String, E&gt;: Jackson 3 writes and
   * reads it with toString() (default {@code EnumFeature}s), the conversion service with name()
   */
  public enum ByName {
    A("name a"), B("name b");
