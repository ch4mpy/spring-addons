...
nav_order: 2
description: "The test companion of spring-addons-starter-oidc: preparing the test context, and the MockMvcSupport and WebTestClientSupport helpers."
---

# `spring-addons-starter-oidc-test`


`spring-addons-starter-oidc-test` builds on top of [`spring-addons-oauth2-test`]({{ site.baseurl }}/testing/annotations/) and adds:
