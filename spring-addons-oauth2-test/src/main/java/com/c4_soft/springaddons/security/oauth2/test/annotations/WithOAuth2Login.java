...
/**
 * <p>
 * Populates the test security context with an {@link OAuth2AuthenticationToken} instance with a {@link DefaultOAuth2User} as principal.
 * </p>
 * <p>
 * Only the annotation properties are used to build the authentication Instance. <b>Neither {@link OAuth2UserService} nor
 * {@link GrantedAuthoritiesMapper} are called.</b>
 * </p>
...
public @interface WithOAuth2Login {
	...
	/**
	 * @return the key used to access the user's &quot;name&quot; from claims. This takes precedence over OpenIdClaims::usernameClaim if both
	 *         are defined
	 */
	...
	public static final class OAuth2AuthenticationTokenFactory extends AbstractAnnotatedAuthenticationBuilder<WithOAuth2Login, OAuth2AuthenticationToken> {
		@Override
