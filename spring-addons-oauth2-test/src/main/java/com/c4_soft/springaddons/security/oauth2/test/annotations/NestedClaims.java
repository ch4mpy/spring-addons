...
public @interface NestedClaims {
    ...
    /**
     * @return Claims containing JSON number representing the number of seconds from
     *         1970-01-01T00:00:00Z as measured in UTC to be parsed as Java Date
     */
    IntClaim[] epochSecondClaims() default {};

    /**
     * @return Claims containing JSON string with "yyyy-MM-dd'T'HH:mm:ss.SSSXXX"
     *         format to be parsed as Java Date. "epochSecondClaims" is generally be
     *         preferred to this representation (this is the case for OpenID claims
     *         like "exp", "iat", "auth_time" and "updated_at")
     */
