...
/**
 * Annotation to setup test {@link SecurityContext} with an {@link Authentication} instantiated by
 * the (Reactive)OpaqueTokenAuthenticationConverter in the security conf. Usage on tests decorated
 * with &#64;AutoConfigureAddonsSecurity or &#64;AutoConfigureAddonsWebSecurity::
 *
 * <pre>
 * &#64;Test
 ...
 * </pre>
 *
 * For usage with &#64;ParameterizedTest, you'll need a {@link MethodSource &#64;MethodSource} in a
 * test running with &#64;TestInstance(Lifecycle.PER_CLASS). Authentication instance should be
 * injected in the test with &#64;ParameterizedAuthentication.
 *
 * <pre>
 * &#64;Autowired
 ...
 * </pre>
 *
 * If using spring-addons-oauth2-test without spring-addons-starter-oidc-test, you should explicitly
 * import &#64;Import(AuthenticationFactoriesTestConf.class) (otherwise, the &#64;Addons...Test will
 * pull this configuration for you)
 *
...
public @interface WithOpaqueToken {
  ...
  public static final class AuthenticationFactory
    ...
    /**
     * @param annotation Test annotation with reference to a classpath resource or a JSON string to
     *        get claims from (and optional JWT headers and Bearer string)
    ...
    /**
     * Build an {@link Authentication} for each of the claim-sets provided as classpath resources
     * (JSON file)
     *
     * @param classpathResources classpath resources to get user claims from
     * @return a stream of {@link Authentication} instances built by the opaque token authentication
     *         converter in security configuration (using default Bearer String)
     */
    public Stream<Authentication> authenticationsFrom(String... classpathResources) {
      return Stream.of(classpathResources).map(AuthenticationFactory::parseFile)
          .map(claims -> this.authentication(claims, DEFAULT_BEARER));
    }
    ...
    public static Map<String, Object> parseFile(String fileName) {
      ...
      try {
        ...
        throw new RuntimeException(
            "Invalid user claims payload in classpath resource %s".formatted(fileName));
      }
    }
