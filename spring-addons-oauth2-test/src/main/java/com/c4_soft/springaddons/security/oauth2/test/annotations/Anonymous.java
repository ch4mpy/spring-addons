...
/**
 * <p>
 * Populates {@link SecurityContext} with an
...
@Inherited
@Documented
@WithSecurityContext(factory = Anonymous.Factory.class)
public @interface Anonymous {
    ...
    public static final class Factory implements WithSecurityContextFactory<Anonymous> {
        ...
        @Override
        public SecurityContext createSecurityContext(Anonymous annotation) {
        ...
        public AnonymousAuthenticationToken authentication(Anonymous annotation) {
