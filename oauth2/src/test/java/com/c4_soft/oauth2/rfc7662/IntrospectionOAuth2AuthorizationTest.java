...
import com.c4_soft.oauth2.rfc7662.IntrospectionOAuth2Authorization;
...
public class IntrospectionOAuth2AuthorizationTest {
	...
	@Before
	public void setUp() {
		builder = IntrospectionOAuth2Authorization.builder().accessToken(claims -> claims.subject("test"));
	}

	@Test(expected = RuntimeException.class)
	public void defaultBuilderThrowsException() {
		IntrospectionOAuth2Authorization.builder().build();
	}
