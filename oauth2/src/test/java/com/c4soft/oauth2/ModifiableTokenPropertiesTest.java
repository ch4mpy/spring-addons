 ...
 *
 */
public class ModifiableTokenPropertiesTest {

	@Test
	public void putActuallyPutsValue() {
		final var props = new ModifiableTokenProperties();
	...
	public void putOverwritesExisingValue() {
		final var props = new ModifiableTokenProperties(Map.of("name1", "value1"));
