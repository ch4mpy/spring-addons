...
import com.c4soft.springaddons.showcase.IntrospectionJpaAuthoritiesResourceServer;

@RunWith(SpringRunner.class)
@WebMvcTest( ShowcaseController.class )
@ContextConfiguration(classes = IntrospectionJpaAuthoritiesResourceServer.class)
