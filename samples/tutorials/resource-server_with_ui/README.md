...
com.c4-soft.springaddons.security.issuers[0].location=http://localhost:8443/realms/master
...
spring.security.oauth2.client.provider.keycloak.issuer-uri=http://localhost:8443/realms/master
