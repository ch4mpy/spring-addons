...
public class ProxiesAuthentication extends OAuthentication<ProxiesClaimSet> {
    ...
    public ProxiesAuthentication(ProxiesClaimSet claims, Collection<? extends GrantedAuthority> authorities,
            String tokenString) {
    ...
    public String getName() {
        return Optional.ofNullable(super.getAttributes().getPreferredUsername())
                .orElse(super.getAttributes().getSubject());
    }
