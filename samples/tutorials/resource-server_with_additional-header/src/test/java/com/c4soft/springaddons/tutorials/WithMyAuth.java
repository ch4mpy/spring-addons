...
public @interface WithMyAuth {
  ...
  public static final class MyAuthFactory
      extends AbstractAnnotatedAuthenticationBuilder<WithMyAuth, MyAuth> {
    public MyAuthFactory() {
      super(WithMyAuth.class);
    }
    ...
    public MyAuth authentication(WithMyAuth annotation) {
      ...
      return new MyAuth(super.authorities(annotation.authorities(), annotation.value()),
          annotation.accessTokenString(), accessClaims, annotation.idTokenString(), idClaims);
    }
  }
}
