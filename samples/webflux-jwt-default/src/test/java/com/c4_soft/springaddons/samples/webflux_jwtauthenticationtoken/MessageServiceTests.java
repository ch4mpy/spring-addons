...
class MessageServiceTests {
  ...
  void givenUserIsPersona_whenGetGreet_thenReturnsGreeting(
  ...
  void givenUserIsAuthenticatedWithMockedAuthentication_whenGetGreet_thenReturnsGreeting() {
    ...
    when(auth.getAuthorities())
        .thenReturn(List.of(new SimpleGrantedAuthority("ROLE_AUTHORIZED_PERSONNEL")));

    assertThat(messageService.greet(auth).block())
