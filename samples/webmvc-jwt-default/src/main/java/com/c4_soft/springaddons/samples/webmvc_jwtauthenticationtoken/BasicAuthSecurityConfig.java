...
/**
 * <p>
 * This is just for demonstration purpose for
 * https://github.com/keycloak/keycloak/discussions/10187
 * </p>
 * <p>
 * Here, we add a security filter chain for requests with Basic authentication.
 * The authentication manager in this filter-chain first retrieves tokens using
 * password-grant flow, and then delegates to an OAuth2 authentication manger
 * (after replacing the Basic Authorization header to a Bearer one containing
 * the
