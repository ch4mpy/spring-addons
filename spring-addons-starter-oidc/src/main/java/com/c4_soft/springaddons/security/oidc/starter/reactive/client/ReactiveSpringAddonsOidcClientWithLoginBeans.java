 ...
 * property are intercepted by this filter-chain.</li>
 ...
 * <li>logoutSuccessHandler: a {@link ServerLogoutSuccessHandler}. Default instance is a
 * {@link SpringAddonsServerLogoutSuccessHandler} which logs a user out from the last authorization
 * server he logged on</li>
 ...
 * "com.c4-soft.springaddons.oidc.client.csrf" is set to cookie</li>
 * <li>clientAuthorizePostProcessor: a {@link ClientAuthorizeExchangeSpecPostProcessor} post
 ...
 * <li>clientHttpPostProcessor: a {@link ClientReactiveHttpSecurityPostProcessor} to override
 ...
 * <li>authorizationRequestResolver: a {@link ServerOAuth2AuthorizationRequestResolver} to add
 * custom parameters (from application properties) to authorization code request</li>
 * </ul>
 *
...
public class ReactiveSpringAddonsOidcClientWithLoginBeans {
   ...
   * handle it. Otherwise Spring Boot default generated one is used</li>
   ...
   * <li>as usual, apply {@link ClientAuthorizeExchangeSpecPostProcessor} for access control
   * configuration from Java conf and {@link ClientReactiveHttpSecurityPostProcessor} to override
   * anything from the auto-configuration listed above</li>
   * </ul>
   *
