 ...
 * <li>clientHttpPostProcessor: a {@link ClientSynchronizedHttpSecurityPostProcessor} to override anything from above auto-configuration. It is called just
...
public class SpringAddonsOidcClientWithLoginBeans {
     ...
     * @param authenticationEntryPoint the {@link AuthenticationEntryPoint} to use. Default is {@link SpringAddonsAuthenticationEntryPoint}
     ...
     * @param oidcBackChannelLogoutHandler if present, Back-Channel Logout is enabled. A default {@link OidcBackChannelLogoutHandler} is provided if
    ...
    InvalidSessionStrategy invalidSessionStrategy(SpringAddonsOidcProperties addonsProperties) {
        final var location = addonsProperties
            .getClient()
            .getLoginUri()
            .orElse(
                UriComponentsBuilder
                    .fromUri(addonsProperties.getClient().getClientUri())
                    .pathSegment(addonsProperties.getClient().getClientUri().getPath(), "/login")
                    .build()
                    .toUri())
            .toString();
        log
