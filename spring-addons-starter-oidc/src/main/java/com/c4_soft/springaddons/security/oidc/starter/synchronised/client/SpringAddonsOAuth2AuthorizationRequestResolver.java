...
public class SpringAddonsOAuth2AuthorizationRequestResolver implements OAuth2AuthorizationRequestResolver {
    ...
    public OAuth2AuthorizationRequest resolve(HttpServletRequest request) {
        ...
        delegate.setAuthorizationRequestCustomizer(authRequestCustomizers.getOrDefault(registrationId, defaultOAuth2AuthorizationRequestCustomizer));
    ...
    public OAuth2AuthorizationRequest resolve(HttpServletRequest request, String clientRegistrationId) {
        savePostLoginUrisInSession(request);
        delegate.setAuthorizationRequestCustomizer(authRequestCustomizers.getOrDefault(clientRegistrationId, defaultOAuth2AuthorizationRequestCustomizer));
