...
```xml
    <properties>
        <springaddons.version>9.2.0</springaddons.version>
    </properties>
...
- [1. Features](#features)
  ...
  * [1.2. OAuth2 Clients with `oauth2Login`](#features-client)
    ...
    - [1.2.12. Concurrent Refresh Token Flows](#1-2-12)
- [2. Frequently Asked Questions](#faq)
  ...
  * [How to customize the `RestTemplate` used to fetch OpenID Configuration?](#2-15)
- [3. Usage](#usage)
...
#### 1.2.12. <a name="1-2-12"/>Concurrent Refresh Token Flows
...
### 2.15. <a name="2-15"/>How to customize the `RestTemplate` used to fetch OpenID Configuration?
