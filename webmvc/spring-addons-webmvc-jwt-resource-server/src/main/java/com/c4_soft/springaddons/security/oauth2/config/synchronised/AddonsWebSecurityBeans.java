...
public class AddonsWebSecurityBeans {
	 ...
	 * {@link ServerHttpSecurityPostProcessor} bean to override anything from this bean
	 * </p>
	 * .
	 *
	 ...
	 * @return                               A default {@link SecurityWebFilterChain} for servlet resource-servers with JWT decoder (matches all
