...
This lib offers spring-boot auto-configuration for OpenID resource-servers with sensible default configuration for RESTful APIs secured with OIDC, which can be overridden from properties file:
* "stateless" sessions
* disabled CSRF
