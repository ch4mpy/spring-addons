 ...
 * {@code com.c4-soft.springaddons.test.web.default-charset} to test properties, defaulted to {@code application/json} and
 * {@code utf-8}</li>
 * <li>serializes request body according to Content-type using <b>registered message converters</b></li>
 * <li>provides with shortcuts to issue requests in basic but most common cases (no fancy headers, cookies, etc): get, post, patch, put and
 * delete methods</li>
 * <li>wraps MockMvc {@link MockMvc#perform(RequestBuilder) perform} and exposes request builder helpers for advanced cases (when you need
 * to further customize {@link MockHttpServletRequestBuilder} with cookies or additional headers for instance)</li>
 * </ul>
 *
...
public class MockMvcSupport {
	...
	/**
	 * Factory for a generic {@link org.springframework.test.web.servlet.request.MockHttpServletRequestBuilder MockHttpServletRequestBuilder}
	 * with relevant "Accept" and "Content-Type" headers. You might prefer to use {@link #getRequestBuilder(MediaType, String, Object...)
	 * getRequestBuilder} or alike which go further with request pre-configuration or even {@link #get(MediaType, String, Object...) get},
	 ...
	 * {@link org.springframework.test.web.servlet.request.MockHttpServletRequestBuilder MockHttpServletRequestBuilder} factories instead
