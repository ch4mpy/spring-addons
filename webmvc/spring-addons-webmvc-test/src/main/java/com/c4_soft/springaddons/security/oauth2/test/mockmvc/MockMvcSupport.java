 ...
 * {@code utf-8}</li>
 * <li>serializes request body according to Content-type using <b>registered
 * message converters</b></li>
 * <li>provides with shortcuts to issue requests in basic but most common cases
 * (no fancy headers, cookies, etc): get, post, patch, put and
 * delete methods</li>
 * <li>wraps MockMvc {@link MockMvc#perform(RequestBuilder) perform} and exposes
 ...
 * additional headers for instance)</li>
 * </ul>
 *
...
public class MockMvcSupport {
     ...
     *         headers, cookies, etc.
     */
    public MockHttpServletRequestBuilder requestBuilder(Optional<MediaType> accept, Optional<Charset> charset,
     ...
     *         etc.)
     */
    public <T> MockHttpServletRequestBuilder postRequestBuilder(T payload, MediaType contentType, Charset charset,
     ...
     *         etc.)
     */
    public <T> MockHttpServletRequestBuilder postRequestBuilder(T payload, MediaType contentType, MediaType accept,
     ...
     * @return API response to test
     */
    public <T> ResultActions post(T payload, MediaType contentType, MediaType accept, String urlTemplate,
            Object... uriVars) {
     ...
     *         etc.)
     */
    public <T> MockHttpServletRequestBuilder putRequestBuilder(T payload, MediaType contentType, Charset charset,
            String urlTemplate, Object... uriVars) {
     ...
     *         etc.)
     */
    public <T> MockHttpServletRequestBuilder putRequestBuilder(T payload, MediaType contentType, String urlTemplate,
            Object... uriVars) {
     ...
     *         etc.)
     */
    public <T> MockHttpServletRequestBuilder patchRequestBuilder(T payload, MediaType contentType, Charset charset,
            String urlTemplate, Object... uriVars) {
     ...
     *         etc.)
     */
    public <T> MockHttpServletRequestBuilder patchRequestBuilder(T payload, MediaType contentType, String urlTemplate,
            Object... uriVars) {
     ...
     * @return API response to be tested
     */
    public <T> ResultActions patch(T payload, MediaType contentType, Charset charset, String urlTemplate,
            Object... uriVars) {
