...
import com.c4_soft.springaddons.security.oauth2.config.synchronised.AddonsOAuth2ClientBeans;
...
@ImportAutoConfiguration({ AddonsWebSecurityBeans.class, AddonsOAuth2ClientBeans.class, AddonsWebmvcTestConf.class })
