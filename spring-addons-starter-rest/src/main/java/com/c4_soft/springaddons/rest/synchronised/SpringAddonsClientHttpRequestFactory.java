...
public class SpringAddonsClientHttpRequestFactory implements ClientHttpRequestFactory {
   ...
   *        context, if any (populated by Spring Boot auto-configuration since Spring Boot 3.4).
   * @param contextSettings the {@code ClientHttpRequestFactorySettings} bean resolved from the context, if any.
