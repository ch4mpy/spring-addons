...
/**
 * <p>
 * Auto-configures {@link SpringAddonsOidcClientWithLoginBeans} as well as what is already
 * configured by {@link AutoConfigureAddonsWebmvcMinimalSecurity}. To be used to test controllers
 * but not services or repositories (web context is not desired in that case).
 * </p>
 *
