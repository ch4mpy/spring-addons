 ...
 */
public interface AuthenticationConfigurer<T extends Authentication>
    extends WebTestClientConfigurer, MockServerConfigurer, AuthenticationBuilder<T> {
  @Override
  default void beforeServerCreated(@NonNull WebHttpHandlerBuilder builder) {
  ...
  @Override
  default void afterConfigurerAdded(WebTestClient.Builder builder,
  ...
  default <U extends WebTestClientConfigurer & MockServerConfigurer> U configurer() {
    return org.springframework.security.test.web.reactive.server.SecurityMockServerConfigurers
        .mockAuthentication(build());
  }
}
