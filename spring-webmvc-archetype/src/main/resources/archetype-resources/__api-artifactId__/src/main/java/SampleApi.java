...
import ${package}.security.WebSecurityConfig;

@SpringBootApplication(scanBasePackageClasses = { SampleApi.class, CustomExceptionHandler.class, WebSecurityConfig.class })
